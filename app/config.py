...
class Settings:
    ...
    # Model Configuration - RunPod workspace compatibility  
    MODEL_PATH: str = os.getenv("MODEL_PATH", "/workspace/models/wav2lip_gan.pth" if os.path.exists("/workspace") else "models/wav2lip_gan.pth")
    ...
    # Default Video Configuration - RunPod workspace compatibility
    DEFAULT_VIDEO_PATH: str = os.getenv("DEFAULT_VIDEO_PATH", "/workspace/models/default_face.mp4" if os.path.exists("/workspace") else "models/default_face.mp4")
    ...
    # File Storage - RunPod workspace compatibility
    TEMP_DIR: str = os.path.abspath(os.getenv("TEMP_DIR", "/workspace/temp" if os.path.exists("/workspace") else "temp"))
